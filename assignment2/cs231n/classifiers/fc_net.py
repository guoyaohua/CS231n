...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores,out_cache = affine_forward(relu_out,self.params['W2'],self.params['b2'])
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dr, grads['W2'], grads['b2'] = affine_backward(ds,out_cache)
        dh = relu_backward(dr,relu_cache)
        dX,grads['W1'], grads['b1'] =affine_backward(dh,hidden_cache)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for layer_idx in range(self.num_layers - 1):
            #affine
            out, cache["affine%d"%(layer_idx+1)] = affine_forward(layer_input, 
...
>>>>>>> d3a3f09b45da162596eafe9356466d7e750f3d6a
            #Relu
        ...
        #affine
        scores, cache["affine%d"%(self.num_layers)] = affine_forward(layer_input,
